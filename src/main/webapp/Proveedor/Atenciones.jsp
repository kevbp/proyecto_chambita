<%-- 
    Document   : MisChambitas
    Created on : 17 oct. 2024, 22:06:15
...
<html>
    ...
    <body>
                ...
                <div class="offcanvas offcanvas-end text-bg-white" tabindex="-1" id="offcanvasNavbar2" aria-labelledby="offcanvasNavbar2Label">
                    ...
                    <div class="offcanvas-body">
                        ...
                        <ul class="navbar-nav justify-content-end flex-grow-1">
                            <li class="nav-item">
                                <a class="nav-link px-3" href="#">Encontrar chamba</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link px-3 border-bottom border-dark-subtle fw-semibold" href="#">Atenciones</a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="container my-4">
            <h2 class="mb-4">Solicitudes Atendidas</h2>
                    ...
                    <div class="filter-section">
                        ...
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select">
                                    <option selected>Estado de servicio</option>
